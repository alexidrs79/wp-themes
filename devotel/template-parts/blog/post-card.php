<?php
/**
 * Blog loop grid card (Elementor loop template 880).
 *
 * @package Devotel
 */
...
?>
<div data-elementor-type="loop-item" data-elementor-id="880" class="<?php echo esc_attr( $classes ); ?>" data-elementor-post-type="elementor_library" role="listitem">
	<div class="elementor-element elementor-element-350c5b6 e-con-full e-flex e-con e-parent" data-id="350c5b6" data-element_type="container">
		<div class="elementor-element elementor-element-e5b0a22 e-flex e-con-boxed e-con e-child" data-id="e5b0a22" data-element_type="container">
			<div class="e-con-inner">
				<div class="elementor-element elementor-element-8a7194b elementor-widget elementor-widget-theme-post-featured-image elementor-widget-image" data-id="8a7194b" data-element_type="widget" data-widget_type="theme-post-featured-image.default">
					<a href="<?php echo esc_url( get_permalink( $post ) ); ?>">
						<?php echo get_the_post_thumbnail( $post, 'full', array( 'class' => 'elementor-animation-float attachment-full size-full' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
					</a>
				</div>
				...
				<div class="elementor-element elementor-element-15a46e6 elementor-widget elementor-widget-theme-post-title elementor-page-title elementor-widget-heading" data-id="15a46e6" data-element_type="widget" data-widget_type="theme-post-title.default">
					<h2 class="elementor-heading-title elementor-size-default devotel-blog-title-with-arrow">
				...
				<div class="elementor-element elementor-element-72570d9 elementor-widget elementor-widget-theme-post-excerpt" data-id="72570d9" data-element_type="widget" data-widget_type="theme-post-excerpt.default">
					<p><?php echo esc_html( wp_trim_words( wp_strip_all_tags( get_the_excerpt( $post ) ), 18, '…' ) ); ?></p>
				</div>
				<div class="elementor-element elementor-element-6f2f221 e-con-full e-flex e-con e-child" data-id="6f2f221" data-element_type="container">
					<div class="elementor-element elementor-element-ce2259a elementor-author-box--align-left elementor-author-box--image-valign-middle elementor-widget__width-auto elementor-author-box--avatar-yes elementor-author-box--name-yes elementor-author-box--biography-yes elementor-author-box--link-no elementor-widget elementor-widget-author-box" data-id="ce2259a" data-element_type="widget" data-widget_type="author-box.default">
