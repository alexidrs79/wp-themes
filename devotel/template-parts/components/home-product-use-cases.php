<?php
/**
 * Homepage product use-cases cards — markup from boxes.html.
 *
 * @package Devotel
 */
...
$markup_path = get_template_directory() . '/template-parts/components/home-product-use-cases-markup.html';
